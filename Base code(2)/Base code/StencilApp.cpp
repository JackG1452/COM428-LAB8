...
void StencilApp::Draw(const GameTimer& gt)
{
	...
	//TO DO -- Draw the scene objects with the correct blend and stencil PSOs
	//Draw opaque items
	auto passCB = mCurrFrameResource->PassCB->Resource();
	mCommandList->SetGraphicsRootConstantBufferView(2, passCB->GetGPUVirtualAddress());
	DrawRenderItems(mCommandList.Get(), mRitemLayer[(int)RenderLayer::Opaque]);

	//Mark visible mirror pixels
...
void StencilApp::BuildPSOs()
{
	...
	//TO DO - Create a mirror blend state with appropriate stencil test
	...
	//TO DO - Create a reflection blend state with appropriate stencil test
	...
	//TO DO - Create a PSO for shadow objects 
